...
HOUSES = Path("/Users/billy/repos/it-mortgage-mo/research/kozelsk/merged.json")
PHOTOS = ROOT / "public/photos"
OUT = ROOT / "scripts/look-results-kozelsk.jsonl"
SUMMARY = ROOT / "scripts/look-summary-kozelsk.json"
...
PROMPT = """Ты классифицируешь объявление о продаже дома в Козельске (Калужская область) СТРОГО по фото.
